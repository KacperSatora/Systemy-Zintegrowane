...
const MRPTable: React.FC<MRPTableProps> = ({
  ...
  const [isCalculated, setIsCalculated] = useState(false); // Dodajemy stan do kontroli obliczeń
  ...
  const handleCalculate = () => {
    ...
    // Po obliczeniach, zapisujemy dane do stanu
    ...
    setIsCalculated(true); // Ustawiamy, że obliczenia zostały wykonane
  };
  ...
  return (
    <div className="table-container">
      ...
      <div className="control-panel">
        ...
        <button onClick={handleCalculate}>Oblicz</button> {/* Przycisk do uruchomienia obliczeń */}
      </div>
